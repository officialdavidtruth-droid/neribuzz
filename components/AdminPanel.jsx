...
@media (max-width: 768px) {
  .nb-admin-topbar { flex-wrap: wrap !important; gap: 6px !important; height: auto !important; padding: 6px 10px !important; }
  .nb-admin-topbar-left { flex-wrap: wrap !important; gap: 6px !important; padding: 2px 0 !important; }
  .nb-admin-topbar-right { flex-wrap: wrap !important; gap: 4px !important; padding: 2px 0 4px !important; }
  ...
  .nb-admin-tab-btn { font-size: 11px !important; padding: 4px 8px !important; white-space: nowrap !important; }
  .nb-write-article { flex-direction: column !important; margin: -12px !important; height: calc(100vh - 45px) !important; }
  .nb-write-editor { padding: 0 6px 40px !important; }
  .nb-write-title { font-size: 20px !important; }
  .nb-write-content { min-height: 200px !important; padding: 12px !important; }
  .nb-write-toolbar { gap: 1px !important; padding: 4px 4px !important; flex-wrap: wrap !important; }
  .nb-write-toolbar .nb-tool { font-size: 10px !important; padding: 3px 5px !important; min-width: 22px !important; }
  .nb-write-toolbar-hint { display: none !important; }
  .nb-write-permalink { flex-wrap: wrap !important; gap: 4px !important; }
  ...
  return (
    <>
      ...
      <div className="nb-write-article" style={{ 
        ...
        height: isMobile ? "calc(100vh - 45px)" : "calc(100vh - 58px)",
        width: "100%",
        overflow: "hidden",
        position: "relative",
        margin: isMobile ? "-12px" : "-28px",
        padding: 0
      }}>
        ...
        <div style={{ 
          ...
          <div className="nb-write-topbar" style={{ 
            ...
            <div style={{ flex: 1, minWidth: isMobile ? "4px" : "auto" }} />
